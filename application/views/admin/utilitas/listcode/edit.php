    ...
    <div class="col-lg-12">
        <section class="panel">
            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form" action="<?php echo site_url('utilitas/listcode/process/edit/' . $data->id_listcode) ?>" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <input type="text" class="form-control" id="inpListItem" name="inpListItem" value="<?php echo $data->list_item ?>">
                        </div>
                    </div>
                    <div class="form-group">
